<?php /*a:1:{s:47:"/www/wwwroot/cs.dkewl.cn/view/admin/player.html";i:1692156224;}*/ ?>
                        ...
                        <div class="layui-tab-item">
                            <div class="layui-form layui-form-pane">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <textarea class="layui-textarea" style="min-height:0"><script src="https://cdn.bootcdn.net/ajax/libs/jquery/3.6.4/jquery.js"></script></textarea>
                                </div>
                                <div class="layui-form-item">
                                    <blockquote class="layui-elem-quote layui-quote-nm" style="margin: 10px 0;">
                                        （非必要）如果播放器按钮显示异常（方框），将此段代码插入到网站的&#60;header&#62;，或播放器代码之前
                                    </blockquote>
                                    <textarea class="layui-textarea" style="min-height:0"><link rel="stylesheet" id='font-awesome-css' href="https://cdn.staticfile.org/font-awesome/4.7.0/css/font-awesome.min.css" type='text/css' media='all'></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="layui-tab-item">
