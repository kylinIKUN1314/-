...
class Api extends Common
{
    ...
    {
        // 接口为集成接口找人写的花费800RMB，需要的找笒鬼鬼可以500出
        $guiguiurl="https://musicapi.cenguigui.cn/lihua.php";//接口地址
		$data=input('get.');
		if(!array_key_exists("HTTP_REFERER",$_SERVER)){
			$url=$guiguiurl.'?input='.$data['songId'].'&filter=id&type='.$data['type'].'&page=1&url='.$_SERVER["SERVER_NAME"];
		}else{
