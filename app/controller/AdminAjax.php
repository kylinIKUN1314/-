			...
			case 'search':
				...
				switch ($data['type']) {
					case 'netease':
						...
						$data = send_get('https://music.163.com/api/v6/playlist/detail?s=0&id='.$body['eparams'].'&n=150&t=0');
						$arr = json_decode($data, true);
						$songs = [];
						foreach ($arr['playlist']['tracks'] as $value) {
							$songs[] = array(
						...
						// $data=send_get('https://music.163.com/api/linux/forward?eparams='.$body['eparams'],1,'https://music.163.com/');
						// $arr=json_decode($data, true);
						// $songs = [];
