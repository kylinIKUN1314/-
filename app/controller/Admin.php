...
class Admin extends Common
{
	...
	public function QqLoginSet()
	{
	    ...
	    $guiguiurl = "https://$serverName/";//获取本地链接
		$userInfo = Users::getLoginUser();
		header("Location: {$guiguiurl}/qqlogin/api.php?callback=".get_domain()."/Admin/set_callback/uid/".$userInfo['uid']);
		exit();
	}
	...
	public function QqLogin()
	{
		$serverName = $_SERVER['SERVER_NAME'];
	    $guiguiurl = "https://$serverName/";//获取本地链接
		header("Location: {$guiguiurl}/qqlogin/api.php?callback=".get_domain()."/Admin/login_callback");
		exit();
	}
